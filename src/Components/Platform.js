  ...
  return (
    <div className='hoverDiv' style={{ width:'fit-content'}}>
      <div style={{display:'flex', flexDirection:'column'}}>
        <div style={{display:'flex', flexDirection:'column', marginLeft:'1em', marginBottom:'1em', zIndex:'5', transform: 'rotateY(33deg)', alignItems:'center', 
         padding:'0.5em', paddingRight:'2em', paddingLeft:'2em' }}>
          {props.children}
        </div>
