...
function TopLeftPiece() {
  ...
  return (
    ...
    paddingLeft:'3px', paddingBottom:'2px', paddingTop:'2px', marginRight:'-2em',
    transform: loaded ? 'translateX(0) translateY(0)' : 'translateX(-110%) translateY(-1000%) rotate(180deg)',transition: 'transform 2s ease',}}>
